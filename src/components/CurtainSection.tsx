    ...
    <section className="relative h-screen w-full overflow-hidden bg-white">
      ...
      {stage !== 'image' && (
        <button
          ...
          style={{ backgroundColor: 'rgba(92, 32, 24, 0.7)', color: 'white' }}
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <div className="relative flex items-center justify-center">
                <div className="absolute w-16 h-16 rounded-full border-2" style={{ borderColor: 'rgba(255, 255, 255, 0.5)', transform: 'scale(1.5)', opacity: 0 }} />
                <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.15)', border: '2px solid rgba(255, 255, 255, 0.4)' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.9 }} aria-hidden="true">
                    <title>Hand</title>
              ...
              <p className="mt-4 font-body text-xs tracking-wide text-center" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
